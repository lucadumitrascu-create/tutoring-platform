...
export default function NewAssignmentPage() {
  ...
  return (
    <div className="max-w-3xl">
      ...
      <h1 className="text-2xl font-bold text-gray-900 mb-1">Temă nouă</h1>
      <p className="text-gray-500 mb-8">Creează o temă pentru acest grup.</p>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div>
          ...
          <p className="text-xs text-gray-400 mb-3">Atașează PDF-uri, imagini sau videoclipuri cu cerințele temei.</p>
