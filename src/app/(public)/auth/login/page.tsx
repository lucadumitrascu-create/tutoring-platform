      ...
      <div className="flex-1 flex items-center justify-center px-4 pb-12">
        <div className="w-full max-w-md">
          <div className="bg-paper shadow-sm border border-sketch p-8" style={{ borderRadius: '2px 8px 4px 6px' }}>
            <h1 className="text-2xl font-bold font-hand text-ink mb-1">Bine ai revenit</h1>
            <p className="text-ink-lighter mb-6">Autentifică-te pentru a accesa contul tău.</p>

            {/* Login type tabs */}
            <div className="flex bg-[#f0e8d8] rounded-lg p-1 mb-8">
              <button
                type="button"
            ...
            {loginType === 'student' && (
              <div className="mt-6 pt-6 border-t border-sketch-light text-center">
                <p className="text-sm text-ink-lighter">
                  Nu ai cont?{' '}
                  <Link href="/auth/register" className="text-sketch-dark font-medium hover:underline">
                    Înregistrează-te
                  </Link>
                </p>
              </div>
