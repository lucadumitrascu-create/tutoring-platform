  ...
  return (
    <div className="relative">
      ...
      <input
        ...
        className="w-full pl-9 pr-8 py-2.5 text-sm border border-sketch rounded-lg focus:ring-2 focus:ring-sketch-dark focus:border-sketch-dark outline-none bg-paper"
      />
      {local && (
        <button
