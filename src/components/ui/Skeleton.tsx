export function SkeletonLine({ className = '' }: { className?: string }) {
  return <div className={`animate-pulse bg-sketch-light/50 rounded ${className}`} />;
}

export function SkeletonCard() {
  return (
    <div className="bg-paper border border-sketch rounded-2xl p-5 space-y-3">
...
export function SkeletonTable({ rows = 5 }: { rows?: number }) {
  return (
    <div className="bg-paper border border-sketch rounded-2xl overflow-hidden">
      <div className="border-b border-sketch-light px-5 py-3 flex gap-8">
      ...
      {Array.from({ length: rows }).map((_, i) => (
        <div key={i} className="border-b border-sketch-light/50 last:border-0 px-5 py-4 flex items-center gap-4">
    ...
    <div className="space-y-8">
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        {Array.from({ length: 4 }).map((_, i) => (
          <div key={i} className="bg-paper border border-sketch rounded-2xl p-5 space-y-2">
